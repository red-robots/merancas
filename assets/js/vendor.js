        ...
        updateSlides: function updateSlides() {
          ...
          for (var _i6 = 0; _i6 < c; _i6 += 1) {
            ...
            if (C && e.grid.updateSlide(_i6, _n3, c, t), "none" !== _n3.css("display")) {
              ...
              p[_i6] && (p[_i6].swiperSlideSize = $), m.push($), a.centeredSlides ? (y = y + $ / 2 + E / 2 + x, 0 === E && 0 !== _i6 && (y = y - r / 2 - x), 0 === _i6 && (y = y - r / 2 - x), Math.abs(y) < 0.001 && (y = 0), a.roundLengths && (y = Math.floor(y)), T % a.slidesPerGroup == 0 && u.push(y), h.push(y)) : (a.roundLengths && (y = Math.floor(y)), (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup == 0 && u.push(y), h.push(y), y = y + $ + x), e.virtualSize += $ + x, E = $, T += 1;
            }
          }
        ...
        translateTo: function translateTo() {
          ...
          if (p = a && e > o ? o : a && e < d ? d : e, r.updateProgress(p), n.cssMode) {
            ...
            if (0 === t) l[_e31 ? "scrollLeft" : "scrollTop"] = -p;else {
              ...
              l.scrollTo(_defineProperty(_defineProperty({}, _e31 ? "left" : "top", -p), "behavior", "smooth"));
            }
            return !0;
          }
    ...
    t({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _l11 = 0; _l11 < t.length; _l11 += 1) {
          ...
          if (_w2 || _b) {
            var _e75 = Math.pow(1 - Math.abs((Math.abs(_p6) - 0.5) / 0.5), 0.5);
            _g3 += -28 * _p6 * _e75, _f4 += -0.5 * _e75, _v3 += 96 * _e75, _h4 = -25 * _e75 * Math.abs(_p6) + "%";
          }
          ...
          if (a.slideShadows) {
            ...
            0 === _e77.length && (_e77 = Z(a, _o10)), _e77.length && (_e77[0].style.opacity = Math.min(Math.max((Math.abs(_p6) - 0.5) / 0.5, 0), 1));
          }
